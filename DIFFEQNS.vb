...
Module DIFFEQNS
    ...
    Sub main_program2(ByVal itcounter As Integer, ByVal oSprinklers As Object, ByVal osprdistributions As Object, ByVal oSmokeDets As Object, ByVal osddistributions As Object)
        ...
        Try
            ...
            ReDim UWallNodeMaxTemp(MMaxWallNodes)
            ReDim LWallNodeMaxTemp(MMaxWallNodes)
            ReDim CeilingNodeStatus(MMaxCeilingNodes)
            ReDim WallNodeStatus(MMaxWallNodes)
            ReDim UWallNodeStatus(MMaxWallNodes)
            ReDim LWallNodeStatus(MMaxWallNodes)
            ReDim flamespread(1)
            ReDim product(1)
...
99:
        ...
        Catch ex As Exception
            MsgBox(Err.Description, MsgBoxStyle.Exclamation, "Exception in DIFFEQNS.vb main_program2")
