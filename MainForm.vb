...
Public Class frmMainForm
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Using cn As New OleDbConnection(ConnectionString)
            ...
            Dim CountriesStatement = (From C In Views.AsEnumerable
                                      Where C.Item(QueryNameColumn).ToString = "qryCountries"
    ...
    Private Sub cmdWhere1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdWhere1.Click
        ...
        If Rows.Count = 1 Then
            ...
            Dim SelectStatement = Rows(0).Item(StatementColumn).ToString.Replace(";", " ") &
